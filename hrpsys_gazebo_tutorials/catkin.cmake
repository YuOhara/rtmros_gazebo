...
find_package(catkin REQUIRED COMPONENTS collada_urdf euscollada hrpsys_ros_bridge hrpsys_ros_bridge_tutorials)
...
catkin_package(
    DEPENDS
    CATKIN_DEPENDS collada_urdf euscollada hrpsys_ros_bridge hrpsys_ros_bridge_tutorials
...
macro (generate_gazebo_urdf_file _robot_name)
  ...
  # this dependency means that run install_robot_common.sh after executing all of ${compile_robots}.
    add_custom_command(OUTPUT ${_out_urdf_file}
      COMMAND ${PROJECT_SOURCE_DIR}/robot_models/install_robot_common.sh ${_robot_name} ${hrpsys_ros_bridge_tutorials_SOURCE_DIR}/models  ${hrpsys_gazebo_tutorials_SOURCE_DIR}/robot_models/${_robot_name} ${collada_urdf_PREFIX}/lib/collada_urdf/collada_to_urdf ${PROJECT_SOURCE_DIR}/..
      DEPENDS ${PROJECT_SOURCE_DIR}/robot_models/install_robot_common.sh ${_out_dir}/hrpsys ${_out_dir}/meshes ${collada_urdf_PREFIX}/lib/collada_urdf/collada_to_urdf ${compile_robots})
